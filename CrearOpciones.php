...
<body>
    <header>
        ...
        <h1 style="color: #333;">Crear opciones</h1>
    </header>
    ...
    <div class="container mt-4">
        <form method="post" action="OpcionesCreados.php">
            <h3 style="color: blue;">Selecciona las carreras que deseas agregar a tu lista:</h3>
            ...
            <h3 style="color: red;">Intrucciones de uso </h3>
            <p>
            Seleccione las carreras que desea estudiar o le interesen. Puede elegir una o varias opciones. Al finalizar, haga clic en 'Agregar a la lista' para ver las opciones que ha seleccionado. 
            También puede generar un PDF con su lista personalizada. 
            El buscador se actualiza en tiempo real al escribir el nombre de una carrera.
